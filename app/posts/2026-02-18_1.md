...
- ここで不変として引数にしてるのに、pushメソッドで内部を変更してしまってるからダメなんだな
...
- まあそうだよね
- buildでわかるからRustがいいわけだしね
- 時間切れ

## まとめ

- 時間かけてるけどまぁ使わなさそうだなとおもう
- こんだけ大変だからbuildで怒られようって啓示かもね
- `Deref`を実装してるのは`RefCell`じゃないんだとおもう
